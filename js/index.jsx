...
var Place;
(function (Place) {
    Place[Place["top"] = 0] = "top";
    Place[Place["bottom"] = 1] = "bottom";
})(Place || (Place = {}));
// 计算tip放置位置的left，top值
...
function Tooltip({ children, place = 'top', size = 1, width = 'max-content', arrowSize = 8, }) {
    ...
    return (<div ref={tooltipRef} className='tooltip' style={Object.assign(Object.assign({}, placement), { fontSize: size + 'rem', width })} onClick={(e) => {
            e.stopPropagation();
        }}>
            {isShow &&
            <>
